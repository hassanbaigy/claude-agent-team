...
const ROSTER_PRESETS = {
  ...
  standard: ["lead", "scout", "reviewer", "test-writer", "e2e-tester", "planner", "investigator", "db-analyst", "ops-scout"],
  full: ["lead", "scout", "reviewer", "test-writer", "e2e-tester", "planner", "investigator", "db-analyst", "ops-scout", "security-auditor", "frontend-designer"],
};
